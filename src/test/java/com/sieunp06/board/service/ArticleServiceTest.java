...
class ArticleServiceTest {
    ...
    @InjectMocks private ArticleService sut; // System Under Test 테스트 대상이다.
    @Mock private ArticleRepository articleRepository;

    @DisplayName("게시글을 검색하면 게시글 리스트를 반환한다.")
    @Test
    void givenSearchingParamter_whenSearchingArticles_thenReturnsArticlesList() {
        // Given
    ...
    void givenArticleInfo_whenSavingArticle_thenSavesArticle() {
        // Given
        ArticleDto dto = ArticleDto.of(LocalDateTime.now(), "sieun", "title", "content", "#hashtag");
    ...
    @Test
    void givenArticleIdAndModifiedInfo_whenModifyingArticle_thenModifiesArticle() {
        // Given
        given(articleRepository.save(any(Article.class))).willReturn(null);
